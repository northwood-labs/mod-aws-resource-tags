...
# Handle some very specific templates the first time.
cp -vf "${RUNNER_TEMP}/updates/cliff.tmpl.toml" "${PWD}/cliff.toml"
mkdir -p "${PWD}/.vscode"
cp -vf "${RUNNER_TEMP}/updates/.vscode/extensions.tmpl.jsonc" "${PWD}/.vscode/extensions.json"
cp -vf "${RUNNER_TEMP}/updates/.vscode/settings.tmpl.jsonc" "${PWD}/.vscode/settings.json"
